...
# xo.assert_allclose(rfb.zeta0, tw_rad.zeta[0], rtol=0, atol=1e-12)
...
# xo.assert_allclose(rfb.zeta0, 0, rtol=0, atol=1e-4)
...
# xo.assert_allclose(np.mean(p.zeta), tw_rad.zeta[0], rtol=0, atol=2e-3)
